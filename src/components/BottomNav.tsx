...
export function BottomNav({ active, onNavigate, soundEnabled=false }: {
  ...
  return (
    <div className="relative z-20 shrink-0"
      style={{ background:'rgba(3,6,12,0.94)', backdropFilter:'blur(24px)', WebkitBackdropFilter:'blur(24px)',
        ...
        {NAV.map(({id,label,Icon})=>{
          ...
          return (
            <button key={id}
              ...
              {on && (
                <motion.div layoutId="nav-bar" className="absolute top-0 left-3 right-3 h-0.5 rounded-b-full"
